...
CREATE TABLE IF NOT EXISTS `Endereco` (
  ...
  PRIMARY KEY (`idEndereco`, `Equipe_idEquipe`),
  INDEX `fk_Endereco_Equipe1_idx` (`Equipe_idEquipe` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Funcionario` (
  ...
  `idEquipe` INT NOT NULL,
  `Engenheiro_idFuncionario` INT NOT NULL,
  PRIMARY KEY (`idFuncionario`, `Engenheiro_idFuncionario`),
  INDEX `fk_Funcionario_Equipe1_idx` (`idEquipe` ASC) VISIBLE,
  INDEX `fk_Funcionario_Engenheiro1_idx` (`Engenheiro_idFuncionario` ASC) VISIBLE,
  CONSTRAINT `fk_Funcionario_Equipe1`
    FOREIGN KEY (`idEquipe`)
    REFERENCES `Equipe` (`idEquipe`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Funcionario_Engenheiro1`
    FOREIGN KEY (`Engenheiro_idFuncionario`)
...
CREATE TABLE IF NOT EXISTS `Inovacao` (
  ...
  `idEngenheiro` INT NOT NULL,
  PRIMARY KEY (`idInovacao`, `idEngenheiro`),
...
-- Table `Piloto_Fã`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Piloto_Fã` (
  `idFuncionario` INT NOT NULL,
  `idFã` INT NOT NULL,
  PRIMARY KEY (`idFuncionario`, `idFã`),
  INDEX `fk_Piloto_has_Fã_Fã1_idx` (`idFã` ASC) VISIBLE,
  INDEX `fk_Piloto_has_Fã_Piloto1_idx` (`idFuncionario` ASC) VISIBLE,
